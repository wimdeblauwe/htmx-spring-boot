...
/**
 * Verifies that security handlers apply the appropriate htmx-friendly redirect strategy based on the request type.
 * Tests include login failure and success, logout, unauthorized access, and forbidden access.
 *
 * @author LC Nicolau
 * @since 5.0.0
 */
