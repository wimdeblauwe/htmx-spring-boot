...
class HtmxPartialHandlerInterceptorTest {
    ...
    public void testHeaders() throws Exception {
        mockMvc.perform(get("/partials/triggers"))
               ...
               .andExpect(header().string("HX-Trigger-After-Settle", "{\"usersCountedSettle1\":{\"value\":\"aDetail\"},\"usersCountedSettle2\":null}"))
               .andExpect(header().string("HX-Trigger-After-Swap", "{\"usersCountedSwap\":{\"value\":\"swap detail\"}}"))
