...
public class HtmxReswap {
    ...
    public String toString() {
        ...
        if (focusScroll != null) {
            value += " focus-scroll:" + focusScroll.toString();
        }
        if (swap != null) {
            value += " swap:" + swap.toMillis() + "ms";
        }
        if (settle != null) {
            value += " settle:" + settle.toMillis() + "ms";
        }
        if (scroll != null) {
            if (scrollTarget != null) {
                value += " scroll:" + scrollTarget + ":" + scroll.getValue();
            } else {
                value += " scroll:" + scroll.getValue();
            }
        }
        if (show != null) {
            if (showTarget != null) {
                value += " show:" + showTarget + ":" + show.getValue();
            } else {
                value += " show:" + show.getValue();
            }
        }
